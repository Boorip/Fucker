...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Fake_Scout")
BOT_USERNAME = getenv("BOT_USERNAME", "ScoutMusicBot")
BOT_NAME = getenv("BOT_NAME", "˹sᴄᴏᴜᴛ ✘ ʀᴏʙᴏᴛ˼")
